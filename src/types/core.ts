...
export const ErrorCode = {
  ...
  TREE_SITTER_WASM_LOAD_FAILED:    "TREE_SITTER_WASM_LOAD_FAILED",
  TREE_SITTER_PARSE_FAILED:        "TREE_SITTER_PARSE_FAILED",
  TREE_SITTER_ADAPTER_DISPOSED:    "TREE_SITTER_ADAPTER_DISPOSED",
  ...
  RUNTIME_REQUEST_ABORTED:      "RUNTIME_REQUEST_ABORTED",
  RUNTIME_WASM_INIT_FAILED:     "RUNTIME_WASM_INIT_FAILED",
  RUNTIME_API_AUTH_FAILED:     "RUNTIME_API_AUTH_FAILED",
  RUNTIME_API_NETWORK_ERROR:   "RUNTIME_API_NETWORK_ERROR",
  RUNTIME_API_RATE_LIMITED:    "RUNTIME_API_RATE_LIMITED",
  RUNTIME_MODEL_NOT_LOADED:    "RUNTIME_MODEL_NOT_LOADED",
  RUNTIME_STREAM_PARSE_ERROR:  "RUNTIME_STREAM_PARSE_ERROR",
  AI_WORKER_NOT_READY:         "AI_WORKER_NOT_READY",
  AI_SEQ_OUT_OF_ORDER:         "AI_SEQ_OUT_OF_ORDER",
...
export const AIProviderPreference = {
  Auto:         "auto",
  OfflineFirst: "offline_first",
  CloudFirst:   "cloud_first",
  OfflineOnly:  "offline_only",
} as const;
export type AIProviderPreference = Values<typeof AIProviderPreference>;
