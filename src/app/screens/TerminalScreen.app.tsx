 ...
 *   RootNavigator src/screens/TerminalScreen.tsx'i doğrudan kullanır.
 *
 ...
 *
 *   Mevcut özellikler:
 *     • EventBus runtime olayları (runtime:started/finished/error/output)
...
const INITIAL_LINES: ConsoleLine[] = [
  { id: 0, text: "mobile-ai-ide terminal v1.0",                 stream: "system", timestamp: Date.now() },
